...
$cases = @(
    [pscustomobject]@{ name = 'signed-pass'; expected = $true; json = '{"status":"pass","installed_manifest":{"present":true,"valid":true,"bridge_version":"4.2.0-alpha.63","issue_count":0,"issue_codes":[]},"health_issue":null}' },
