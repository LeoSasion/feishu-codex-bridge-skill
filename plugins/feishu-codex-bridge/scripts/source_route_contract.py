"""Classify a Feishu Bridge tree without treating documentation as authority.
...
def _validate_plugin_tree(plugin_root: Path) -> tuple[str, str]:
    ...
    desktop = [
        ...
        and component["name"].casefold() == "desktop_bridge"
    ]
    if (
        len(desktop) != 1
        or desktop[0].get("name") != "desktop_bridge"
