...
Published plugin: `1.1.0`; development source runtime: `4.2.0-alpha.131`. Operator（接线员）maps each Feishu private
...
Alpha.131 补充显式的新建任务输入兼容，并原样传递已探测的摘要参数；
源码中的修复尚不代表当前 Desktop 文件操作已验收通过。
